...
###1.纯公司内网 
	安装的机器内网ip为： 202.182.121.247
	
**login_server:**

	ClientListenIP=202.182.121.247		
	ClientPort=8008
	HttpListenIP=202.182.121.247
	HttpPort=8080
	MsgServerListenIP=202.182.121.247	
	MsgServerPort=8100
	msfs=http://202.182.121.247：8700/
	discovery=http://202.182.121.247/api/discover
	
**msg_server:**
	
	ListenIP=202.182.121.247
	ListenPort=8000

	ConcurrentDBConnCnt=2
	DBServerIP1=202.182.121.247
	DBServerPort1=10600
	DBServerIP2=202.182.121.247
	DBServerPort2=10600

	LoginServerIP1=202.182.121.247
	LoginServerPort1=8100

	RouteServerIP1=202.182.121.247
	RouteServerPort1=8400
	
	PushServerIP1=202.182.121.247
	PushServerPort1=8500

	FileServerIP1=202.182.121.247
	FileServerPort1=8600

	IpAddr1=202.182.121.247 	
	IpAddr2=202.182.121.247		
	MaxConnCnt=100000
...
**db_proxy:**
	...
	MsfsSite=202.182.121.247	

	#configure for mysql
	DBInstances=teamtalk_master,teamtalk_slave
	#teamtalk_master
	teamtalk_master_host=202.182.121.247
	...
	#teamtalk_slave
	teamtalk_slave_host=202.182.121.247
	...
	#未读消息计数器的redis
	unread_host=202.182.121.247
	unread_port=6379
	unread_db=1
	unread_maxconncnt=16

	#群组设置redis
	group_set_host=202.182.121.247
	group_set_port=6379
	group_set_db=2
	group_set_maxconncnt=16

	#同步控制
	sync_host=202.182.121.247
	sync_port=6379
	sync_db=3
	sync_maxconncnt=1

	#deviceToken redis
	token_host=202.182.121.247
	token_port=6379
	token_db=4
	token_maxconncnt=16

	#GroupMember
	group_member_host=202.182.121.247
...
###2.公网ip
	...
	内网ip为：202.182.121.247
	公网ip为202.182.121.247
...
**msfs_server:**
	...
	ListenIP=202.182.121.247;202.182.121.247		
	ListenPort=8600
	BaseDir=./tmp
	FileCnt=0
	FilesPerDir=30000
